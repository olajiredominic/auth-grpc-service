...
var file_pkg_pb_user_service_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x49, 0x64, 0x22, 0x2e, 0x0a, 0x11, 0x55, 0x70, 0x64,
	...
	0x73, 0x65, 0x72, 0x52, 0x04, 0x55, 0x73, 0x65, 0x72, 0x22, 0x23, 0x0a, 0x11, 0x44, 0x65, 0x6c,
	...
	0x55, 0x73, 0x65, 0x72, 0x22, 0x00, 0x12, 0x2e, 0x0a, 0x0a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
...
var file_pkg_pb_user_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_pkg_pb_user_service_proto_goTypes = []interface{}{
	...
	(*model.User)(nil),            // 6: User
	(*emptypb.Empty)(nil),         // 7: google.protobuf.Empty
}
var file_pkg_pb_user_service_proto_depIdxs = []int32{
	5, // 0: user.ListUsersRequest.CreatedAt:type_name -> google.protobuf.Timestamp
	5, // 1: user.ListUsersRequest.ModifiedAt:type_name -> google.protobuf.Timestamp
	6, // 2: user.ListUsersResponse.Users:type_name -> User
	6, // 3: user.UpdateUserRequest.User:type_name -> User
	...
	6, // 6: user.UserService.CreateUser:input_type -> User
	...
	6, // 10: user.UserService.GetUser:output_type -> User
	6, // 11: user.UserService.CreateUser:output_type -> User
	6, // 12: user.UserService.UpdateUser:output_type -> User
